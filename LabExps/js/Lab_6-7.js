...
function process_6_7()
	...
	if (thisAlg === 't')
		...
		throw('Houston, we have a problem in process_6_7.');
	...
	console.log('|H(0)| = ',fpsd[0].toFixed(5), rpsd[0].toFixed(5), (fpsd[0]/rpsd[0]).toFixed(5), 
		Math.sqrt(fpsd[0]/rpsd[0]).toFixed(5));
	};
...
function myFunctionZoom(val)
	...
	if (newSamples <= maxDTdisplay)
		...
		else if (experiment === '6.7b')
			fpl.yaxis4.tickformat = '.5s'
		else if (experiment === '6.7c')
			fpl.yaxis4.tickformat = fpl.yaxis4.tickformat // do nothing
		else if (experiment === '6.7d')
			fpl.yaxis4.tickformat = fpl.yaxis4.tickformat // do nothing
		else throw('Lab 6.7.js: Problem in myFunctionZoom()');
